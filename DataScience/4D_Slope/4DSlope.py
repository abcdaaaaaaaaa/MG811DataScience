...
ppm = Sensorppm(temperature, rh, interpolate(SensorValue, 0, 1, emf_min, emf_max), selected_gas, time)
...
ppm_surface = Sensorppm(temperature_surface, rh_surface, interpolate(SensorValue_surface, 0, 1, emf_min, emf_max), selected_gas, time_surface)
